...
INSERT INTO `album` VALUES (1,'Black Holes and Revelations',2,'https://t2.genius.com/unsafe/315x315/https%3A%2F%2Fimages.genius.com%2F4c4be3f77c029986e345e6d991cdd9ef.1000x1000x1.png'),(2,'Plants Vs. Zombies (Original Video Game Soundtrack) (2010)',1,'https://t2.genius.com/unsafe/315x315/https%3A%2F%2Fimages.genius.com%2F8a0af8a68112243f0524dd8f6a4dec14.1000x1000x1.jpg');
...
INSERT INTO `album_by_artist` VALUES ('Muse',1),('Laura Shigihara',2);
...
INSERT INTO `artist` VALUES ('Laura Shigihara'),('Muse');
...
CREATE TABLE `genres` (
  ...
  KEY `SONG_TITLE_GENRES_idx` (`SONG_TITLE`),
  CONSTRAINT `ALBUM_ID_GENRES` FOREIGN KEY (`ALBUM_ID`) REFERENCES `album` (`ALBUM_ID`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SONG_TITLE_GENRES` FOREIGN KEY (`SONG_TITLE`) REFERENCES `song` (`SONG_TITLE`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `genres` VALUES ('Rock',1,'Assassin'),('Rock',1,'Knights of Cydonia'),('Soundtrack',2,'Loonboon');
...
CREATE TABLE `mp3` (
  ...
  KEY `SONG_TITLE_MP3_idx` (`SONG_TITLE`),
  CONSTRAINT `SONG_TITLE_MP3` FOREIGN KEY (`SONG_TITLE`) REFERENCES `song` (`SONG_TITLE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mp3` VALUES ('5701a31c1fa648466147c6e24943304d','Assassin'),('a6d5fe0ffe1325a0d7bb8aa147cfc1d8','Knights of Cydonia'),('cd4c93dd2a751ad8824e498ac5c86c3b','Loonboon');
...
INSERT INTO `song` VALUES ('Assassin',1,2006,7),('Knights of Cydonia',1,2006,11),('Loonboon',2,2010,5);
...
CREATE TABLE `submission` (
  ...
  CONSTRAINT `GENRES` FOREIGN KEY (`GENRE`) REFERENCES `genres` (`GENRE`),
  CONSTRAINT `MP3_HASH` FOREIGN KEY (`MP3_HASH`) REFERENCES `mp3` (`HASH_CODE`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `SONG_TITLE` FOREIGN KEY (`SONG_TITLE`) REFERENCES `song` (`SONG_TITLE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `submission` VALUES (1,'2023-12-06 04:26:51','5701a31c1fa648466147c6e24943304d','Muse','Assassin',1,'Black Holes and Revelations',2006,'Rock',7,'https://t2.genius.com/unsafe/315x315/https%3A%2F%2Fimages.genius.com%2F4c4be3f77c029986e345e6d991cdd9ef.1000x1000x1.png'),(2,'2023-12-06 04:29:21','a6d5fe0ffe1325a0d7bb8aa147cfc1d8','Muse','Knights of Cydonia',1,'Black Holes and Revelations',2006,'Rock',11,'https://t2.genius.com/unsafe/315x315/https%3A%2F%2Fimages.genius.com%2F4c4be3f77c029986e345e6d991cdd9ef.1000x1000x1.png'),(3,'2023-12-06 04:32:56','cd4c93dd2a751ad8824e498ac5c86c3b','Laura Shigihara','Loonboon',2,'Plants Vs. Zombies (Original Video Game Soundtrack) (2010)',2010,'Soundtrack',5,'https://t2.genius.com/unsafe/315x315/https%3A%2F%2Fimages.genius.com%2F8a0af8a68112243f0524dd8f6a4dec14.1000x1000x1.jpg');
...
INSERT INTO `user_submission` VALUES (1),(2),(3);
...
-- Dump completed on 2023-12-06  0:50:33
